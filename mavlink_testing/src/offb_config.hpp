...
#define OFFB_DEBUG_START_DELAY 1.5 // sec

#define OFFB_MIN_FLIGHT_ALT    0.1 // m, less is considered on ground
#define OFFB_ALT_MARGIN        0.3 // m, navigate when alt +- margin
#define OFFB_ABORT_ALT         2.5 // m, max allowed altitude
...
#define OFFB_ROLL_YAW_COUPL           0.05
...
#define OFFB_PID_ALT_BIAS             0.0 // output bias
#define OFFB_PID_ALT_P                0.20 //0.2
#define OFFB_PID_ALT_I                0.06 //0.06
#define OFFB_PID_ALT_D                0.06 //0.02
...
#define OFFB_PID_PITCH_MAX_OUTPUT      (5*DEG) // pitch angle rad
#define OFFB_PID_PITCH_MIN_OUTPUT     (-5*DEG)
#define OFFB_PID_PITCH_MAX_OUTPUT_RAMP (2*DEG)
#define OFFB_PID_PITCH_BIAS             0.0 // output bias
#define OFFB_PID_PITCH_P              (-0.7*DEG)
#define OFFB_PID_PITCH_I                0.0
#define OFFB_PID_PITCH_D              (-0.5*DEG)
...
#define OFFB_PID_ROLL_MAX_OUTPUT      (5*DEG) // Bank angle rad
#define OFFB_PID_ROLL_MIN_OUTPUT     (-5*DEG)
#define OFFB_PID_ROLL_MAX_OUTPUT_RAMP (2*DEG)
#define OFFB_PID_ROLL_BIAS             0.0 // output bias
#define OFFB_PID_ROLL_P              (-3.0*DEG)
#define OFFB_PID_ROLL_I                0.00
#define OFFB_PID_ROLL_D              (-2.0*DEG)
...
#define OFFB_PID_YAW_P                -3.0
#define OFFB_PID_YAW_I                 0.0
#define OFFB_PID_YAW_D                -3.0
