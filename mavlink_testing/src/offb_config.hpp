...
#define OFFB_ALT_TARGET               1.0 // metres
...
#define OFFB_PID_PITCH_MAX_OUTPUT      (1*DEG) // pitch angle rad
#define OFFB_PID_PITCH_MIN_OUTPUT     (-1*DEG)
#define OFFB_PID_PITCH_MAX_OUTPUT_RAMP (5*DEG)
#define OFFB_PID_PITCH_BIAS             0.0 // output bias
#define OFFB_PID_PITCH_P              (-0.01/9.81)
#define OFFB_PID_PITCH_I                0.0
#define OFFB_PID_PITCH_D              (-0.8/9.81)
...
#define OFFB_PID_ROLL_D              (-2.0/9.81)
...
#define OFFB_PID_YAW_P                -0.3
#define OFFB_PID_YAW_I                 0.0
#define OFFB_PID_YAW_D                -0.5
